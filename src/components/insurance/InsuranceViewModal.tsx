...
interface WhyLoveViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  insuranceData: WhyLoveData | null;
}

export function InsuranceViewModal({
  isOpen,
  onClose,
  insuranceData,
              ...
              <div className="bg-muted/50 p-4 rounded-sm space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-3 w-3 rounded-full ${insuranceData.isActive ? "bg-green-500" : "bg-gray-400"
                        }`}
                    ></div>
                    <span className="text-sm">
                      <span className="font-medium">Status:</span>{" "}
                      {insuranceData.isActive ? "Active" : "Inactive"}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      ...
                      {format(new Date(insuranceData.createdAt), "PPP")}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      ...
                      {format(new Date(insuranceData.updatedAt), "PPP")}
                    </span>
                  </div>
                </div>
              </div>
