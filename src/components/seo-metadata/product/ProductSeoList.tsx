...
export default function ProductSeoList() {
    const { entityId } = useParams<{ entityId: string }>();
    const navigate = useNavigate();

    const { data, isLoading, error } = useGetSeoByEntity("PRODUCT", entityId || "", true);
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
                <div className="flex w-full justify-between items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Product SEO Optimization</h1>
                        <p className="text-sm text-muted-foreground">
                            Manage SEO metadata for this product
                        </p>
                    </div>
                    ...
                    {seo && (
                        ...
                        <Button
                            ...
                            onClick={() => navigate(`/dashboard/products/${entityId}/seo/edit/${seo.id}`)}
                        >
                ...
                {!seo && !error && (
                    <Link to={`products/${entityId}/seo/create`}>
                        <Button >
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground mt-2">
                                        This product doesn't have SEO metadata yet.
                                    </p>
                                </div>
                                <Button onClick={() => navigate(`/dashboard/products/${entityId}/seo/create`)}>
                                    <Plus className="w-4 h-4 mr-2" />
                                    Create SEO Metadata
                                </Button>
                            </div>
