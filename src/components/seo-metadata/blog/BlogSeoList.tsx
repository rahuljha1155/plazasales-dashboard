...
export default function BlogSeoList() {
    const { entityId } = useParams<{ entityId: string }>();
    const navigate = useNavigate();

    const { data, isLoading, error } = useGetSeoByEntity("BLOG", entityId || "", true);
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
                <div className="flex w-full justify-between items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Blog SEO Optimization</h1>
                    ...
                    {seo && (
                        ...
                        <Button
                            ...
                            onClick={() => navigate(`/dashboard/blogs/${entityId}/seo/edit/${seo.id}`)}
                        >
                ...
                {!seo && !error && (
                    <Link to={`blogs/${entityId}/seo/create`}>
                        <Button >
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground mt-2">
                                        This blog post doesn't have SEO metadata yet.
                                    </p>
                                </div>
                                <Button onClick={() => navigate(`/dashboard/blogs/${entityId}/seo/create`)}>
                                    <Plus className="w-4 h-4 mr-2" />
                                    Create SEO Metadata
                                </Button>
                            </div>
